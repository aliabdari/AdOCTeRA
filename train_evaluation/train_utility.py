...
def retrieve_indices():
    if os.path.exists('../indices/indices.pkl'):
        ...
        with open('../apartments_data/apartments_data.pkl', 'rb') as f:
...
def get_entire_data():
    descriptions_path = '../open_clip_features/descriptions_ViT-B-32_laion2b_s34b_b79k/sentences'
    scene_path = '../open_clip_features/images_ViT-B-32_laion2b_s34b_b79k'
    return descriptions_path, scene_path
