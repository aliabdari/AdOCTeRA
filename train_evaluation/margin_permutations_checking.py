...
def start_train(args):
    set_seed(seed=5965528221795689748)
    ...
    relevance_info = similarity_metric if is_txt_similarity else pickle.load(
        open('../scenes_relevances/relevance_structural.pkl', 'rb'))
    ...
    train_utility.evaluate(output_description=output_description_test,
