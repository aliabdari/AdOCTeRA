...
```
python margin_permutations_checking.py -txt_sim --thresh_l 0.25 --thresh_u 0.75 --margin_m 0.30 --margin_h 0.35
```
### Arguments
...
## Environment
To run the Experiments we have used Python 3.10, with torch 2.5.0+cu124, with NVIDIA L40 GPU
